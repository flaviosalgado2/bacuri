...
const { data: resultado, pending, refresh } = await useLazyAsyncData('contas-receber', () => listar(filtros, { pagina: pagina.value, limite: itensPorPagina.value }), { watch: [filtros, itensPorPagina] })
